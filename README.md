...
<p>
	Welcome to the School Management REST API project! This API is designed to
	manage various aspects of a school, including administrative functions,
	academic years, class levels, programs, subjects, teachers, students, and
	exams. Below you'll find details on how to set up, use, and contribute to
	this project.
</p>
...
<ul>
	...
	<li>
		...
		<ul>
			...
			<li><a href="#academic-terms">Academic Terms</a></li>
			<li><a href="#class-levels">Class Levels</a></li>
...
<ol>
	<li>
		...
		<pre><code>git clone https://github.com/frksarkar/school-management-api.git 
cd school-management-API </code></pre>
	...
	<li>
		<p>
			Set up environment variables. Create a <code>.env</code> file in the
...
<p>
	...
	<a rel="noreferrer">LICENSE</a> file for details.
</p>
